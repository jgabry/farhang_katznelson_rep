### changes from SpatialStan_08_13_2014 ###

# 1. aapct moved from X to Z
...
// Predictors w/ effects assumed constant over regional/temporal dims ##
  matrix[N, C]            Z ;  # dem party & labor committee indicators, and aapct  
  
// Predictors to get smoothing priors
  matrix[N, R]            X[J] ;  # urbanpct, unionpop, & incidence matrix (formerly M)
