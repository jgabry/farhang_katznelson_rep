...
rm(list = ls())
setwd("/home/jsg2201/wawro/The_Real_Deal/Aug24")
...
fit.compile <- stan(file = "the_slow_way.stan", data = mvn_prec_data, chains = 0)
...
for(i in 1:3){
  ...
  png(file = paste0("pairs_",i,".png"), w = 10, h = 10, un = "in", res = 150) 
