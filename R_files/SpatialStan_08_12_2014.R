...
fit.compile <- stan(file = "SpatialStan_08_12_2014.stan", data = mvn_prec_data, chains = 0)

fit.test <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, iter = 30, refresh = 5)

chain1 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, iter = 3000, refresh = 25)
chain6 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, iter = 3000, refresh = 25)
