...
fit.compile <- stan(file = "aa_separate.stan", data = mvn_prec_data, chains = 0)


fit.test <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, iter = 30, refresh = 5)


chain_1 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 1, iter = 2500, refresh = 25)
save(chain_1, file = "Aug22_chain_1.RData")
chain_2 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 2, iter = 2500, refresh = 25)
save(chain_2, file = "Aug22_chain_2.RData")


chain_3 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 3, iter = 2500, refresh = 50)
save(chain_3, file = "Aug22_chain_3.RData")
chain_4 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 4, iter = 2500, refresh = 50)
save(chain_4, file = "Aug22_chain_4.RData")


chain_5 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 5, iter = 2500, refresh = 50)
save(chain_5, file = "Aug22_chain_5.RData")
chain_6 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 6, iter = 2500, refresh = 50)
save(chain_6, file = "Aug22_chain_6.RData")


chain_7 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 7, iter = 2500, refresh = 50)
save(chain_7, file = "Aug22_chain_7.RData")
chain_8 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 8, iter = 2500, refresh = 50)
save(chain_8, file = "Aug22_chain_8.RData")


chain_9 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 9, iter = 2500, refresh = 50)
save(chain_9, file = "Aug22_chain_9.RData")
chain_10 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 10, iter = 2500, refresh = 50)
save(chain_10, file = "Aug22_chain_10.RData")


chain_11 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 11, iter = 2500, refresh = 50)
save(chain_11, file = "Aug22_chain_11.RData")
chain_12 <- stan(fit = fit.compile, data = mvn_prec_data, chains = 1, chain_id = 12, iter = 2500, refresh = 50)
save(chain_12, file = "Aug22_chain_12.RData")



# load finished chains
sflist <- list()
dir.path <- "Stan_tests/Aug_22nd/all_chains/"

for (i in 1:12) {
  file <- paste0(dir.path,"Aug22_chain_",i,".RData")  
  load(file)
